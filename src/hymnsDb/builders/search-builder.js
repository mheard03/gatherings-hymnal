...
import normalizeToAscii from '../search/normalize-to-ascii.js';
import { buildSearchIndex, buildDocuments } from '../search/hymns-db-indexer.js';
...
function processSearchResults(rawResults) {
  ...
  for (let result of processed) {
    ...
    result.hymn = hymns.get(result.hymnId);
