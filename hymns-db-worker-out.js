(() => {
  ...
  var HymnsBuilder = class {
    static async build(hymnsDbInstance, router) {
      ...
      let hymnals2 = hymnsDbInstance.getHymnals();
  ...
  var arrayUrl = new URL("../../assets/hymns-db-generated.json", import_meta.url);
  var versionUrl = new URL("../../assets/hymns-db-version.txt", import_meta.url);
  ...
  function createAlphaSections(hymnsDbInstance, hymnal) {
    let hymns3 = hymnsDbInstance.getHymns(hymnal.hymnalId);
  ...
  var SearchBuilder = class {
    static async build(hymnsDbInstance) {
      hymns2 = hymnsDbInstance.getAllHymns();
  ...
  self.hymnsDb = new hymns_db_default();
